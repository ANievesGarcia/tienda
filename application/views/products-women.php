	...
	<!-- Product Listing -->
		...
		<div class="row">
		<?php foreach($mujeres as $producto): ?>
			...
			<div class="pagination">
			  <ul>
			  	<?php if($paginaActual != 1): ?>
			  		<li><a href="<?php echo base_url(); ?>principal/mujeres/<?php echo $paginaActual-1;?>">Anterior</a></li>
				<?php endif ?>
				
			    <?php for ($i=1;$i<=$paginas;$i++): ?>
			   		 <li><a href="<?php echo base_url(); ?>principal/mujeres/<?php echo $i;?>"><?php echo $i;?></a></li>
			    <?php endfor ?>
			    <?php if($paginaActual != $paginas): ?>
					<li><a href="<?php echo base_url(); ?>principal/mujeres/<?php echo $paginaActual+1;?>">Siguiente</a></li>
				<?php endif ?>
			  </ul>
			</div>
		</div>
